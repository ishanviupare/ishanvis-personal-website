...
const about = () => {
  return (
    ...
    <div className="h-auto xl:h-screen xl:overflow-hidden">
        <div className = "h-full bg-[#c6b0ad] text-[#5a4a46] font-serif p-3 lg:p-20 flex flex-col">
        <h1 className = "text-5xl lg:text-6xl p-4 lg:mb-16"> About... </h1>
          <div className = "min-h-0 mx-auto max-w-9/10 max-h-full flex flex-col xl:flex-row gap-12">
            ...
            <div className = "w-full h-[300px] xl:h-auto overflow-hidden rounded-xl shadow-xl">
              <img src = "profile.webp" className = "object-cover w-full min-w-50 h-full min-h-130"/>
            </div>
            </div>

            
            <div className = "xl:w-3/5 bg-[#5a4a46] text-[#c6b0ad] leading-9 sm:text-lg xl:text-2xl p-5 lg:p-12 shadow-xl rounded-xl">
            <div className = "h-full overflow-y-auto lg:pr-10 lg:-mr-2 scrollbar-custom space-y-6">
